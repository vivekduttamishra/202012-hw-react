...
export const ACTION_BOOKS_GET_ALL='ACTION_BOOKS_GET_ALL';
export const ACTION_BOOKS_ADD='ACTION_BOOKS_ADD';
export const ACTION_BOOK_GET_BY_ISBN='ACTION_BOOK_GET_BY_ISBN';
...
export const getAllBooks=()=>{
    ...
    return {type: ACTION_BOOKS_GET_ALL,payload:books};
}

export const addBook=( book:Book)=>{
    
    return {type: ACTION_BOOKS_ADD,payload:book};
}

export const getBookByIsbn=( isbn:string)=>{
    
    let book:null|undefined|Book=books.find(book => book.isbn===isbn);
    if(!book)
        book=null;

    return {type: ACTION_BOOK_GET_BY_ISBN,payload:book};
}
